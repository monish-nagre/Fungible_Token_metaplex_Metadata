...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var myKeypair, mint, seed1, seed2, seed3, signer, _a, metadataPDA, _bump, accounts, dataV2, args, ix, tx, connection, txid;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    console.log("let's name some tokens!");
                    myKeypair = loadWalletKey("/home/monish/.config/solana/id.json");
                    console.log(myKeypair.publicKey.toBase58());
                    mint = new web3.PublicKey("FUNWwYoCfQ7r9sc9S5ua7S1cBxBdFmhWp7JHCWypSwVy");
                    ...
                    signer = new web3_js_1.PublicKey("38J8f4VG8syxqWmRsYt8pbFf8Edeh1hoPvAuBnF4Vp6U");
